    ...
    function initContactsMap() {
      ...
      const zoom = window.mapZoom ?? 14,
        ...
        MainMarkerLayout = ymaps.templateLayoutFactory.createClass(
          ['<div class="ya-main-placemark">', "<span></span>", "</div>"].join(
            ""
          )
        ),
            ...
            "</div>",
          {
            ...
            applyElementOffset: function () {
              this._$element.css({
                left: -46,
                top: -(
                  this._$element[0].offsetHeight / 2 +
      ...
      objectManager.objects.events.add("click", function (e) {
        ...
        mapInstance.panTo(object.geometry.coordinates, { delay: 0 }).then(
          function () {
            mapInstance.setZoom(zoom + 1, { duration: 300 });
          },
          function (err) {
            console.log("ошибка");
          }
